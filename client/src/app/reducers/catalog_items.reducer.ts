...
export const initState: CatalogItemInit = {
    display_catalog_item: {id: '123' , title: 'Leather Sneakers' , price: 115, sale_price: 85 , sizes: ['6','6.5','7','7.5','8','8.5','9','10','11','12','13'] , new: false , sale: true , colors: ['Yellow', 'Red' , 'Violet'], img: 'https://cm.rlmedia.io/is/image/PoloGSI/s7-1255555_lifestyle?$CMPDP$' , category: 'Shoes' , season: '' , brand: 'Nike' , reviews: []} 
}
